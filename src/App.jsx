  ...
  return (
    <main className="invitation">
      ...
      <section className="panel-grid" aria-label="Wedding invitation">
        <article className="panel panel-intro" id="top"><div className="fine-arc arc-top" /><div className="orbit-orbit" aria-hidden="true"><span className="orbit-dot orbit-dot-one" /><span className="orbit-dot orbit-dot-two" /></div><p className="eyebrow">A beautiful<br />journey together</p><div className="intro-copy"><p className="desktop-kicker">The theory of us</p><h1 className="mobile-title"><small>the</small><span>THEORY</span><small>of</small><span>CHAWANLAK <b>&amp;</b> SUMRERNG</span></h1><h1 className="desktop-title"><span className="desktop-title-line">the <strong>THEORY</strong> of</span><span className="desktop-title-names"><span>CHAWANLAK</span><b>&amp;</b><span>SUMRERNG</span></span></h1><span className="mini-rule" /><p>Every moment led to you</p></div><img className="portrait portrait-full" src={pageOnePhoto || welcomeCard} alt="Chawanlak and Sumrerng together" loading="eager" fetchPriority="high" /><div className="intro-bottom"><footer className="panel-footer"><p>PAE <span>&amp;</span> RERNG</p><strong>14.11.2026</strong></footer><p className="desktop-invite">ขอเชิญร่วมเป็นส่วนหนึ่งในวันสำคัญของเรา</p></div></article>
        ...
        <article className="panel panel-details" id="details"><div className="fine-arc arc-left" /><div className="details-mark"><span>PAE</span><span>RERNG</span></div><p className="eyebrow right">Good people<br />Bright days</p><div className="details-copy"><div className="details-date"><small>SATURDAY</small><div><span>NOVEMBER</span><strong>14</strong><span>2026</span></div><p>วันเสาร์ที่ 14 พฤศจิกายน พ.ศ. 2569</p><button className="calendar-button" type="button" onClick={addToCalendar}><svg className="calendar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M16 2v4M8 2v4M3 10h18M8 14h.01M12 14h.01M16 14h.01M8 17h.01M12 17h.01M16 17h.01" /></svg>เพิ่มวันงานลงปฏิทิน</button></div><div className="timeline"><div><img className="timeline-image" src={ceremonyImage} alt="Ceremonial wedding tray with wedding rings" /><strong>15:00</strong><p>พิธีสู่ขอ &amp; พิธีรับไหว้</p><small>THAI WEDDING CEREMONY</small></div><div><img className="timeline-image" src={receptionImage} alt="Wedding reception champagne glasses" /><strong>18:00</strong><p>ฉลองมงคลสมรส</p><small>WEDDING RECEPTION</small></div></div><div className="venue-visual"><img src={locationsPhoto} alt="Wedding venue interior" /></div><div className="venue-row"><p className="venue">ณ สยามเจริญนคร ชั้น 2<br /><small>Siam Charoennakorn, 2nd floor</small></p><a className="outline-button" href="https://www.google.com/maps/dir/?api=1&amp;destination=Siam+Charoennakorn%2C+2nd+floor" target="_blank" rel="noreferrer">ดูแผนที่ <b>→</b></a></div><p className="dress-code">No dress code.<br />Wear what makes you happy.</p></div></article>
